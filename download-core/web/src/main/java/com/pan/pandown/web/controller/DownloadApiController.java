...
public class DownloadApiController {
    ...
    public BaseResponse getSvipdLink(@RequestBody @Valid DownloadApiDTO downloadApiDTO) {
        ArrayList dlinkList = (ArrayList) downloadService.getDlink(downloadApiDTO);
        LinkedHashMap<String, Object> map = (LinkedHashMap<String, Object>) dlinkList.get(0);
        String dlink = (String) map.get("dlink");
        dlink = (String) downloadService.getSvipDlink(dlink);
